...
const Head = ({setSideBar}) => {
  ...
  return (
    <div className='w-full  p-6 sm:p-4  flex items-center justify-around gap-4 h-[6vw] sm:h-[5vw] overflow-hidden'>
      ...
      <div className='flex items-center gap-8 justify-center w-[20%] sm:w-[10%] cursor-pointer'>

      <FaCircleUser className='text-3xl  sm:text-4xl text-gray-700' />
      <SiYoutubeshorts  className='text-4xl text-red-600'/>
      </div>
    </div>
  )
}
